...
void loop()
{
    ...
    if (glob_analaog_1 != analogRead(analogPin) || glob_analaog_2 != analogRead(analogPin_2))
    {
        ...
        incrementer(glob_analaog_1, &frequency_increment, &glob_frequency, frequency_steps[freq_index]);
        incrementer(glob_analaog_1, &frequency_decrement, &glob_frequency, (-1 * frequency_steps[freq_index]));
        incrementer(glob_analaog_1, &duty_increment, &glob_duty, duty_steps[duty_index]);
        incrementer(glob_analaog_1, &duty_decrement, &glob_duty, (-1 * duty_steps[duty_index]));
...
void display_line_2()
{
    if (button_status_changed)
    {
        ...
        lcd_1.print("                ");
        lcd_1.setCursor(0, 0);
        lcd_1.print("new Fstep= " + String(frequency_steps[freq_index]));

        lcd_1.setCursor(0, 1);
        lcd_1.print("                ");
        lcd_1.setCursor(0, 1);
        lcd_1.print("new Dstep = " + String(duty_steps[duty_index]));

        delay(1000);
        button_status_changed = false;
        lcd_1.setCursor(0, 0);
        lcd_1.print("Freq        Duty");
        lcd_1.setCursor(0, 1);
        lcd_1.print("                ");
